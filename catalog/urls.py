...
from .views import show_courses, create_course, update_course, confirm_delete_course, actually_delete_course, course_admin, course_search_instructor, course_search_days, course_search_class, course_pass, create_pass # .views refer to the views.py in the current directory as this file
